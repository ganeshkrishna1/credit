...
function Statisticslesserincome() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8081/applicants-lesser-income-than-all-engineers")
      .then((res) => {
...
export default Statisticslesserincome;
